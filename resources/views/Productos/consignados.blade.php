...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">Productos consignados <a href="{{route('home')}}" class="btn btn-info">Volver</a></div>
        <div class="card-body">
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center">
                    <a href="{{route('Consigandos.create', $producto->id )}}" class="btn btn-outline-success m-auto">Agregar imagenes</a>
                  </div>
                  <div class="row text-center">
                    <a href="{{route('Consigandos.stock', $producto->id )}}" class="btn btn-outline-success m-auto">Agregar stock</a>
                  </div>
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <a href="{{route('Consigandos.delete', $producto->id)}}" class="btn btn-warning m-auto">Quitar </a>
                    </div>
                  </div>
                </div>
              </div>
