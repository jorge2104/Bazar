...
@endif
@if(Session::has('consignado'))
<div class="alert alert-success" role="alert">
  Producto consignado Correctamente
</div>
@endif

@if(Session::has('nconsignado'))
<div class="alert alert-success" role="alert">
  Consigna quitada Correctamente
</div>
@endif
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      ...
      <div class="card">
        <div class="card-header">Productos del area {{$area->nombre}} </div>
        <div class="card-body">
          <div class="row">
              ...
              <div class="card" >
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    Disponibles: {{$producto->disponibles}}<br>
                  </p>
                  <div class="row">
                    <div class="col-md-12 text-center">
                      @if($producto->consignado == 0)
                      <a href="{{route('Productos.consignar', $producto->id)}}">Consignar</a>
                      @else
                        <a href="{{route('Productos.deleteConsigna', $producto->id)}}">Quitar consigna</a>
                      @endif
                    </div>
                  </div>
                </div>
